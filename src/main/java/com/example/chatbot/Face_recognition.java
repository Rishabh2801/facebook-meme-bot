import java.awt.*;  
 ...
 class processor {  
      ...
      public Mat detect(Mat inputframe){  
          ...
          {
              System.out.println("There is a human face");
          }
          else if(faces.toArray().length > 1)
          {
              System.out.println("There are "+faces.toArray().length+" no of faces");
          }
          else
          {
              System.out.println("There are no human faces");
          }
      }
 }
public class window {  
